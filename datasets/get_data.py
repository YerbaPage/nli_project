...
subprocess.call(['gdown', model_url])
shutil.move('albert-base-v1.state_dict','/')
...
subprocess.call(['gdown', model_url])
shutil.move('albert-large-v2.state_dict','/')
...
subprocess.call(['gdown', model_url])
shutil.move('bert-base_hans.state_dict','/')
